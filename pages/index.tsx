            ...
            >
                ...
                <GridItem colSpan={5}>
                    <div className={styles.about}>
                        <h1 className={styles.about__title}>Екатерина Графова -
                            сертифицированный преподаватель Федерации Йоги России по
                            направлению Хатха-йога (YTTC-200).
                        </h1>
                        <p className={styles.paragraph}>Преподаватель кундалини йоги, йога-нидры. Проводит сеансы гвоздетерапии с применением
                            знаний и
                            навыков психологии.
                            Организатор и ведущая ретритных трансформационных авторских программы, Он-Лайн
                            курсов по
                            наули-крии и медитации.</p>
                    </div>
                </GridItem>
                <GridItem colSpan={5}>
